...
export function BackupReminder() {
  ...
  return (
    <div className="mx-4 mt-2 px-3 py-2 bg-primary/10 border border-primary/20 rounded-lg flex items-center gap-2 text-xs text-primary">
      ...
      <button onClick={() => { saveBrochure(); setDismissed(true) }} className="px-2 py-1 bg-primary text-primary-foreground rounded text-xs hover:bg-primary/90">Save Now</button>
