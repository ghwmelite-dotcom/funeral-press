...
function BannerBackupReminder() {
  ...
  return (
    <div className="mb-3 px-3 py-2 bg-primary/10 border border-primary/20 rounded-lg flex items-center gap-2 text-xs text-primary">
      ...
      <button onClick={() => { saveBanner(); setDismissed(true) }} className="px-3 py-2 bg-primary text-primary-foreground rounded text-xs hover:bg-primary/90">Save Now</button>
