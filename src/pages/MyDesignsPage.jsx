      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-20 pb-16">
        ...
        {allDesigns.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-6 bg-card border border-dashed border-border rounded-xl">
            ...
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-lg transition-colors text-sm"
            >
              Start Creating
            </Link>
          </div>
