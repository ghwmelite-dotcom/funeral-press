...
const PRICING_PLANS = [
  { key: 'single', name: 'Single', desc: 'One poster design download', cta: 'Get Started', primary: false },
  { key: 'bundle', name: 'Bundle', desc: 'Poster + brochure + invitation', cta: 'Best Value', primary: true },
  { key: 'suite', name: 'Suite', desc: 'All designs, unlimited downloads', cta: 'Go Unlimited', primary: false },
]
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <p className="text-muted-foreground text-center mb-4">Pay once, download your A3 print-ready PDF instantly. No subscriptions.</p>
