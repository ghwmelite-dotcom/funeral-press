...
const PRICING_PLANS = [
  { key: 'single', name: 'Single', desc: 'One programme booklet download', cta: 'Get Started', primary: false },
  { key: 'bundle', name: 'Bundle', desc: 'Booklet + brochure + poster', cta: 'Best Value', primary: true },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <p className="text-muted-foreground text-center mb-4">Pay once, download your print-ready A5 booklet PDF. No subscriptions.</p>
